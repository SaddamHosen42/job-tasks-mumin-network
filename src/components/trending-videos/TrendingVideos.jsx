        ...
        {trendingVideos.map((video) => (
          ...
          >
            ...
            <div className="relative">
              ...
              {/* Bottom Stats Bar */}
              <div className="absolute -bottom-5 left-2 right-2 bg-white rounded-full px-3 py-2 flex items-center gap-3">
                {/* Profile Image */}
                <img
                  src={profileIcon}
                  alt="Profile"
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div className="text-center">
                    <p className="text-xs font-bold text-black leading-none">{video.views}</p>
                    <p className="text-[10px] text-gray-500 leading-none">Views</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <div className="text-center">
                    <p className="text-xs font-bold text-black leading-none">{video.loves}</p>
                    <p className="text-[10px] text-gray-500 leading-none">Loves</p>
                  </div>
                </div>
                
                {/* Play Button */}
                <button className="bg-green-500 rounded-full p-2 ml-auto">
                  <img src={videoIcon} alt="Play" className="w-3 h-3" />
                </button>
              </div>
            </div>
